 ...
 *
 * Set EXTENSION_E2E_DIR to load an unpacked package from somewhere else (for example an archive
 * generated by GET /api/browser/extension/chrome), and EXTENSION_E2E_URL to check another origin.
 *
...
const extensionDir = process.env.EXTENSION_E2E_DIR ?? join(root, 'static', 'extensions', 'chrome');
