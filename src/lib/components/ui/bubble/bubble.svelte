	...
	export const bubbleVariants = tv({
		...
		variants: {
			variant: {
				...
				secondary:
					'*:data-[slot=bubble-content]:bg-secondary *:data-[slot=bubble-content]:text-secondary-foreground [&>[data-slot=bubble-content]:is(button,a):hover]:bg-[color-mix(in_oklch,var(--surface-2),var(--text)_5%)]',
				muted:
					'*:data-[slot=bubble-content]:bg-muted [&>[data-slot=bubble-content]:is(button,a):hover]:bg-[color-mix(in_oklch,var(--surface-2),var(--text)_5%)]',
				tinted:
					'*:data-[slot=bubble-content]:bg-[oklch(from_var(--accent-bg)_0.93_calc(c*0.4)_h)] dark:*:data-[slot=bubble-content]:bg-[oklch(from_var(--accent-bg)_0.3_calc(c*0.4)_h)] *:data-[slot=bubble-content]:text-foreground [&>[data-slot=bubble-content]:is(button,a):hover]:bg-[oklch(from_var(--accent-bg)_0.88_calc(c*0.5)_h)] dark:[&>[data-slot=bubble-content]:is(button,a):hover]:bg-[oklch(from_var(--accent-bg)_0.35_calc(c*0.5)_h)]',
				outline:
